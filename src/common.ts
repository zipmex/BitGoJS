...
const setNetwork = function(network) {
  if (network === 'bitcoin') {
...
const getRmgNetwork = function() {
  return rmgNetwork;
};

const setRmgNetwork = function(network) {
  rmgNetwork = network;
};

const setEthNetwork = function(network) {
  ethereumNetwork = 'ethereum';
};

const getEthNetwork = function() {
