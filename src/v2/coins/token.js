...
class Token extends Eth {
  ...
  recover(params, callback) {
    return co(function *recover() {
      ...
      result = yield request.get(this.recoveryBlockchainExplorerQuery(`module=account&action=tokenbalance&contractaddress=${this.tokenContractAddress}&address=${params.walletContractAddress}`)).result();
